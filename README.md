...
openvpn-server/
├── data/pki           <-- здесь будут ключи и конфиги (pki/)
├── data/clients       <-- здесь будут .ovpn файлы клиентов
└── scripts/
...
/etc/openvpn/
├── inner-scripts/     <-- скрипты и шаблоны, остаются внутри контейнера
├── pki/               <-- примонтирована ./data/pki
└── clients/           <-- примонтирована ./data/clients
